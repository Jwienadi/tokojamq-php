            ...
            <div class="container"
                ...
                <div class='row text-center'>
					...
					?>
                        ...
                        <a href='pioneer.php?page=<?php echo $prev_page; ?>' class="btn btn-default" title='Previous'>
						...
						for ($i=1; $i<=$count_pages; $i++){
                            ...
                            if($i==1){
								echo "<a href='pioneer.php?page=$i' class='btn btn-default $flag_class' title='First'>$i</a>";
							} else if($i==$count_pages) {
								echo "<a href='pioneer.php?page=$i' class='btn btn-default $flag_class' title='Last'>$i</a>";
							} else {
								echo "<a href='pioneer.php?page=$i' class='btn btn-default $flag_class' title='Page $i'>$i</a>";
							}
						}
					?>
                        <?php
                        if ($page<$count_pages){
							$next_page = $page+1;
							//echo "Next: ".$next_page;
							echo "<a href='pioneer.php?page=$next_page' class='btn btn-default' title='Next'>
										Next
